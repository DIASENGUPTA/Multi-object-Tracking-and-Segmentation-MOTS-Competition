...
with torch.no_grad():
    ...
    source_cfg_path = "/projectnb/cs585bp/hsharma/bdd100k_converted/bdd/labels/seg_track_20/seg_track_modified_val_cocoformat.json"
...
with open("scoring_metric_ocsort.pkl","wb") as file: ## scoring metric
